...
export const PercentageCalculator = () => {
  ...
  return (
    <ToolCard icon={<Percent className="h-5 w-5" />} title="Percentage Calculator" description="Calculate percentages instantly" example="What is 15% of 200? → 30" faq={[{ q: "How is percentage calculated?", a: "Multiply the value by the percentage and divide by 100." }]} result={result} onReset={() => { setValue(""); setPercent(""); }}>
...
export const AgeCalculator = () => {
  ...
  return (
    <ToolCard icon={<Calendar className="h-5 w-5" />} title="Age Calculator" description="Find your exact age" example="Born Jan 1, 2000 → 26 years, 2 months, 19 days" faq={[{ q: "Does it account for leap years?", a: "Yes, the calculation uses standard date arithmetic which handles leap years." }]} result={result} onReset={() => setDob("")}>
...
export const BMICalculator = () => {
  ...
  return (
    <ToolCard icon={<Activity className="h-5 w-5" />} title="BMI Calculator" description="Check your Body Mass Index" example="70 kg, 175 cm → BMI 22.9 (Normal)" faq={[{ q: "What is a healthy BMI?", a: "A BMI between 18.5 and 24.9 is generally considered healthy." }]} result={result} onReset={() => { setWeight(""); setHeight(""); }}>
      <div className="grid grid-cols-2 gap-3">
...
export const UnitConverter = () => {
  ...
  return (
    <ToolCard icon={<ArrowLeftRight className="h-5 w-5" />} title="Unit Converter" description="Convert between common units" example="10 km → 6.2137 miles" faq={[{ q: "What units are supported?", a: "Distance (km/miles), weight (kg/lbs), and temperature (°C/°F)." }]} result={result} onReset={() => setValue("")}>
...
export const EMICalculator = () => {
  ...
  return (
    <ToolCard icon={<Banknote className="h-5 w-5" />} title="Loan / EMI Calculator" description="Calculate monthly loan payments" example="₹5,00,000 at 8.5% for 5 years → ₹10,254/mo" faq={[{ q: "What formula is used?", a: "EMI = P × r × (1+r)^n / ((1+r)^n − 1)." }]} result={result} onReset={() => { setPrincipal(""); setRate(""); setTenure(""); }}>
      <div className="space-y-3">
...
export const DiscountCalculator = () => {
  ...
  return (
    <ToolCard icon={<Tag className="h-5 w-5" />} title="Discount Calculator" description="Find the price after discount" example="$120 with 25% off → $90 (you save $30)" faq={[{ q: "How is discount calculated?", a: "Final price = Original price × (1 − discount/100)." }]} result={result} onReset={() => { setPrice(""); setDiscount(""); }}>
      <div className="grid grid-cols-2 gap-3">
...
export const TimeDurationCalculator = () => {
  ...
  return (
    <ToolCard icon={<Clock className="h-5 w-5" />} title="Time Duration Calculator" description="Calculate time between two timestamps" example="09:00 to 17:30 → 8 hours 30 minutes" faq={[{ q: "Does it handle overnight durations?", a: "Yes, it wraps around midnight automatically." }]} result={result} onReset={() => { setStart(""); setEnd(""); }}>
      <div className="grid grid-cols-2 gap-3">
...
export const WordCounter = () => {
  ...
  return (
    <ToolCard icon={<FileText className="h-5 w-5" />} title="Word Counter" description="Count words, characters, and sentences" example='"Hello world" → 2 words, 11 characters' faq={[{ q: "How are sentences counted?", a: "Split by periods, exclamation marks, and question marks." }]} result={result} onReset={() => setText("")}>
      <div className="space-y-1.5">
...
export const BinaryDecimalConverter = () => {
  ...
  return (
    <ToolCard icon={<Binary className="h-5 w-5" />} title="Binary ↔ Decimal" description="Convert between binary and decimal" example="42 → 101010" faq={[{ q: "What number range is supported?", a: "Any standard integer within JavaScript's safe integer range." }]} result={result} onReset={() => setValue("")}>
      <div className="space-y-3">
...
export const TipCalculator = () => {
  ...
  return (
    <ToolCard icon={<Calculator className="h-5 w-5" />} title="Tip Calculator" description="Split bills and calculate tips" example="$80 bill, 18% tip, 4 people → $4.60 each" faq={[{ q: "What tip percentage is standard?", a: "15–20% is standard in most countries." }]} result={result} onReset={() => { setBill(""); setTipPct("15"); setPeople("1"); }}>
      <div className="space-y-3">
